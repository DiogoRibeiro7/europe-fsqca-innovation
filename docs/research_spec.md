...
The validator checks that the study-level condition and outcome names match the analysis configuration, that regional schemes exist, that countries are assigned once within the primary taxonomy, and that required output paths stay outside the raw-data area.
